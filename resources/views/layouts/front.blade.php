                                    ...
                                    <div class="select-position">
                                        <form method="POST" action="{{ route('currency.store') }}">
                                            ...
                                            <select name="currency_code">
                                                ...
                                                <option value="EGP" @selected('EGP'==session('currency_code'))>$ CAD</option>
                                                <option value="JOD" @selected('JOD'==session('currency_code'))>₹ JOD</option>
                                                <option value="SAR" @selected('SAP'==session('currency_code'))>¥ SAR</option>
                                    ...
                                    <li>
                                        <form action="{{ route('logout') }}" method="POST" style="display: inline;">
                                            ...
                                            <button type="submit" style="    display: inline-block;
                                                    text-transform: capitalize; background-color: #081828;
                                                    color: #fff;
