                        ...
                        <form class="row" method="post" action="{{ route('register') }}">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="reg-ln">User Name</label>
                                    <input class="form-control" name="name" type="text" id="reg-ln" required>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                            ...
                            <div class="col-sm-6"> --}}
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="phone_number" id="reg-phone" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
